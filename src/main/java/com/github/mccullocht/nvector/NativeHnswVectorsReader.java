 ...
 * @lucene.experimental
 */
public final class NativeHnswVectorsReader extends KnnVectorsReader
    ...
    public NativeHnswVectorsReader(SegmentReadState state, NativeFlatVectorsReader flatVectorsReader)
            throws IOException {
        ...
        try (var meta = state.directory.openInput(metaFileName, IOContext.READONCE)) {
            ...
            try {
                CodecUtil.checkIndexHeader(
                        ...
                        NativeHnswVectorsFormat.VERSION_START,
    ...
    private NativeHnswVectorsReader(
            NativeHnswVectorsReader reader, NativeFlatVectorsReader flatVectorsReader) {
        this.flatVectorsReader = flatVectorsReader;
    ...
    public KnnVectorsReader getMergeInstance() {
        return new NativeHnswVectorsReader(this, this.flatVectorsReader.getMergeInstance());
    }
    ...
    private FieldEntry readField(IndexInput input, FieldInfo info) throws IOException {
        final var nativeField = NativeVectorAccess.IndexField.create(input, this.vectorIndex, this.arena);
        ...
        return FieldEntry.create(input, vectorEncoding, info.getVectorSimilarityFunction(), nativeField);
    }

    @Override
    public long ramBytesUsed() {
        return NativeHnswVectorsReader.SHALLOW_SIZE
                + fields.ramBytesUsed()
    ...
    private void search(
        ...
        if (doHnsw) {
            ...
            // if k is larger than the number of vectors, we can just iterate over all
            // vectors
            // and collect them
    ...
    private record FieldEntry(
            ...
            long offsetsLength,
            Optional<NativeVectorAccess.IndexField> nativeField) {
